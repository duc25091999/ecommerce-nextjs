...
const Filter = ({state,children}) => {
    ...
    return (
        <div className="mt-4">
            ...
            <form autoComplete="off" className="mt-2 col-md-12 px-0">
                <input placeholder='Search...' type="text" className="form-control" list="title_product"
